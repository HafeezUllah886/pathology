...
namespace App\Models {
     ...
     * @property int $typeID
     * @property int $id
     * @property-read \App\Models\User $updat
     * @property-read \App\Models\receipt_type $type
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereTypeid($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereRate($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereUpdatedby($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|charges newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|charges newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|charges query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class charges extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * App\Models\receipt
     *
     * @property date|null $refundedDate
     * @property string|null $desc
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string|null $refundedBy
     * @property enum('yes','no') $refunded
     * @property int $userID
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\receipt_details> $details
     * @property-read int|null $details_count
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereConsultant($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt wherePname($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereContact($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereCnic($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereGender($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereUserid($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereRefunded($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereRefundedby($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereDesc($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt whereRefundeddate($value)
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereReceiptid($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereItemid($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereFee($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_details query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class receipt_details extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\receipt_type
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $updatedBy
     ...
     * @property int $id
     * @property-read \App\Models\User $updat
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type whereUpdatedby($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder|receipt_type query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class receipt_type extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
